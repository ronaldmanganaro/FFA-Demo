...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'WebGlDev.data';
    var REMOTE_PACKAGE_BASE = 'WebGlDev.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 51357547;
      var PACKAGE_UUID = 'e8259fb6-6d2b-44c7-83cc-e69464e7538d';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 41028, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(41028, 60396, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(60396, 67984, 0, 0).open('GET', '/level0');
    new DataRequest(67984, 78692, 0, 0).open('GET', '/level1');
    new DataRequest(78692, 126584, 0, 0).open('GET', '/level2');
    new DataRequest(126584, 137604, 0, 0).open('GET', '/level3');
    new DataRequest(137604, 163188, 0, 0).open('GET', '/level4');
    new DataRequest(163188, 197044, 0, 0).open('GET', '/level5');
    new DataRequest(197044, 197756, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(197756, 203835, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(203835, 668391, 0, 0).open('GET', '/resources.assets');
    new DataRequest(668391, 4685107, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(4685107, 5682703, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(5682703, 8896395, 0, 0).open('GET', '/sharedassets2.assets');
    new DataRequest(8896395, 12513578, 0, 0).open('GET', '/sharedassets2.resource');
    new DataRequest(12513578, 19535382, 0, 0).open('GET', '/sharedassets3.assets');
    new DataRequest(19535382, 42761610, 0, 0).open('GET', '/sharedassets4.assets');
    new DataRequest(42761610, 45753000, 0, 0).open('GET', '/sharedassets4.resource');
    new DataRequest(45753000, 46720992, 0, 0).open('GET', '/sharedassets5.assets');
    new DataRequest(46720992, 47790062, 0, 0).open('GET', '/sharedassets5.resource');
    new DataRequest(47790062, 49771822, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(49771822, 51269194, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(51269194, 51329922, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(51329922, 51357547, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_WebGlDev.data');

    };
    Module['addRunDependency']('datafile_WebGlDev.data');
